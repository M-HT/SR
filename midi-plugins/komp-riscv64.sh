...
cc -shared -Wl,-soname,midi-adlmidi.so -o midi-adlmidi.so -fpic -fvisibility=hidden -O2 -Wall -march=rv64gc $SPEEXDSP_COMPILE midi-adlmidi.c -I`pwd`/include -lADLMIDI $SPEEXDSP_LINK -lstdc++ -L`pwd`/lib/riscv64
...
c++ -c -fpic -fvisibility=hidden -O2 -Wall -march=rv64gc -fno-exceptions emu_mt32.cpp -I$CURDIR/src/munt-2.7.0
cd munt-2.7.0/mt32emu
c++ -c -fpic -fvisibility=hidden -O3 -Wall -march=rv64gc -fno-exceptions *.cpp
...
cd ../../../..
cc -shared -Wl,-soname,mt32-munt.so -o mt32-munt.so -march=rv64gc *.o src/*.o src/munt-2.7.0/mt32emu/*.o src/munt-2.7.0/mt32emu/sha1/*.o -lm $SPEEXDSP_LINK -lstdc++ -L../lib/riscv64
