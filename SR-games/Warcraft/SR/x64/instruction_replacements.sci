...
loc_44120,1,;add esp, 8|add r11d, 8|;ret|RET ; skip calling original timer interrupt
loc_4413C,1,;ret|RET ; timer interrupt ending
loc_4413D,7,;ret|RET ; timer interrupt ending

loc_3CE19,66,nop ; keyboard interrupt ending
loc_3CE64,1,;ret|RET ; keyboard interrupt ending

loc_21F11,5,mov ebx, [Game_stdin] ; fix stdin

loc_2276F,123,mov eax, 0x0a|mov edx, [Game_stdout]|;call SR_fputc|CALL SR_fputc|mov [ebp-0x10], eax ; replace putchar macro
loc_2280E,123,mov eax, [ebp-0x0c]|mov edx, [Game_stdout]|;call SR_fputc|CALL SR_fputc|mov [ebp-0x18], eax ; replace putchar macro
loc_2288E,123,mov eax, 0x0a|mov edx, [Game_stdout]|;call SR_fputc|CALL SR_fputc|mov [ebp-0x20], eax ; replace putchar macro
...
loc_2C193,133,mov eax, [ebp-0x10]|inc dword [ebp-0x10]|mov al, [eax]|and eax, 0xff|mov edx, [ebp-0x0c]|;call SR_fputc|CALL SR_fputc|mov [ebp-0x18], eax ; replace putc macro

loc_16D63,1,;pop ebp|POP32 ebp|;call SR_Sync|CALL SR_Sync ; call sync after save

loc_3B748,2,mov eax, 70|;call SR___delay|CALL SR___delay|xor eax, eax ; insert delay into victory screen
...
loc_22A2E,5,;call SR_memset|CALL SR_memset|cmp dword [Game_Sound], 0|je loc_22A2E_1|mov word [loc_597DE], 0|loc_22A2E_1:|cmp dword [Game_Music], 0|je loc_22A2E_2|mov word [loc_597EE], 0|loc_22A2E_2: ; enable/disable sound,music driver

loc_2F395,15,mov eax, 1 ; fix loading sound driver

loc_2EFB5,15,mov eax, 1 ; fix loading music driver

loc_46545,4,;mov eax, [esp+0x14]|mov eax, [r11d+0x14]|or eax, eax|je loc_46570 ; fix loading NULL samples
