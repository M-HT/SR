...
cd ../../../..
g++ -s -shared -static-libgcc -static-libstdc++ -o mt32-munt.dll -m32 *.o src/*.o src/munt-2.7.0/mt32emu/*.o src/munt-2.7.0/mt32emu/sha1/*.o ../midi.def -lm %SPEEXDSP_LINK% -L../lib/x86
