...
loc_38570,1,;add esp, 8|add r11d, 8|;ret|RET ; skip calling original timer interrupt
loc_3858C,1,;ret|RET ; timer interrupt ending
loc_3858D,7,;ret|RET ; timer interrupt ending

loc_31289,66,nop ; keyboard interrupt ending
loc_312D4,1,;ret|RET ; keyboard interrupt ending

loc_1D880,14, ; replace putchar macro (part 1)
loc_1D893,96,mov eax, 0x0a|mov edx, [Game_stdout]|;call SR_fputc|CALL SR_fputc|jmp short loc_1D95F ; replace putchar macro (part 2)
loc_1D90B,84,mov edx, [Game_stdout]|;call SR_fputc|CALL SR_fputc ; replace putchar macro
loc_1D96B,98,mov eax, 0x0a|mov edx, [Game_stdout]|;call SR_fputc|CALL SR_fputc ; replace putchar macro
...
loc_24A05,80,xor eax, eax|mov al, [ecx]|inc ecx|mov edx, ebx|;call SR_fputc|CALL SR_fputc ; replace putc macro

loc_14C6D,1,;pop ebp|POP32 ebp|;call SR_Sync|CALL SR_Sync ; call sync after save

loc_2FC1B,2,mov eax, 70|;call SR___delay|CALL SR___delay|xor eax, eax ; insert delay into victory screen
...
loc_1DABB,5,;call SR_memset|CALL SR_memset|cmp dword [Game_Sound], 0|je loc_1DABB_1|mov word [loc_59902], 0|loc_1DABB_1:|cmp dword [Game_Music], 0|je loc_1DABB_2|mov word [loc_59912], 0|loc_1DABB_2: ; enable/disable sound,music driver

loc_26F65,15,mov eax, 1 ; fix loading sound driver

loc_26B85,15,mov eax, 1 ; fix loading music driver

loc_3A995,4,;mov eax, [esp+0x14]|mov eax, [r11d+0x14]|or eax, eax|je loc_3A9C0 ; fix loading NULL samples
