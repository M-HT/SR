...
gcc -shared -Wl,-soname,midiA-wildmidi.so -o midiA-wildmidi.so -fpic -fvisibility=hidden -m32 -O2 -Wall midiA-wildmidi.c -I`pwd`/.. -I`pwd`/include -lWildMidiA -L`pwd`/lib/x86
...
g++ -c -fpic -fvisibility=hidden -m32 -O2 -Wall -fno-exceptions emu_mt32.cpp -I$CURDIR/src/munt-1.4.0
