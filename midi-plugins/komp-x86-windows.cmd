...
gcc -s -shared -o midiA-wildmidi.dll -m32 -O2 -Wall midiA-wildmidi.c ../midi.def -I./.. -I./include -lWildMidiA -L./lib/x86
...
cd ../..
gcc -s -shared -o adlib-dosbox_opl.dll -m32 *.o src/*.o src/dosbox_opl/*.o ../midi.def
...
cd ../../../..
gcc -s -shared -o mt32-munt.dll -m32 *.o src/*.o src/munt-1.4.0/mt32emu/*.o src/munt-1.4.0/mt32emu/sha1/*.o ../midi.def -lstdc++
