...
cd ../../../..
link /NOLOGO /DLL /OUT:mt32-munt.dll *.obj src/*.obj src/munt-2.7.0/mt32emu/*.obj src/munt-2.7.0/mt32emu/sha1/*.obj /DEF:..\midi.def /MACHINE:ARM64 %SPEEXDSP_LINK% /LIBPATH:..\lib\arm64
