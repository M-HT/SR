...
loc_38660,1,;add esp, 8|add r11d, 8|;ret|RET ; skip calling original timer interrupt
loc_3867C,1,;ret|RET ; timer interrupt ending
loc_3867D,7,;ret|RET ; timer interrupt ending

loc_313B9,66,nop ; keyboard interrupt ending
loc_31404,1,;ret|RET ; keyboard interrupt ending

loc_1D37B,5,mov ebx, [Game_stdin] ; fix stdin

loc_1D9B4,14, ; replace putchar macro (part 1)
loc_1D9C7,96,mov eax, 0x0a|mov edx, [Game_stdout]|;call SR_fputc|CALL SR_fputc|jmp short loc_1DA93 ; replace putchar macro (part 2)
loc_1DA3F,84,mov edx, [Game_stdout]|;call SR_fputc|CALL SR_fputc ; replace putchar macro
loc_1DA9F,98,mov eax, 0x0a|mov edx, [Game_stdout]|;call SR_fputc|CALL SR_fputc ; replace putchar macro
...
loc_24B35,80,xor eax, eax|mov al, [ecx]|inc ecx|mov edx, ebx|;call SR_fputc|CALL SR_fputc ; replace putc macro

loc_14C6D,1,;pop ebp|POP32 ebp|;call SR_Sync|CALL SR_Sync ; call sync after save

loc_2FD4B,2,mov eax, 70|;call SR___delay|CALL SR___delay|xor eax, eax ; insert delay into victory screen
...
loc_1DBEF,5,;call SR_memset|CALL SR_memset|cmp dword [Game_Sound], 0|je loc_1DBEF_1|mov word [loc_59A42], 0|loc_1DBEF_1:|cmp dword [Game_Music], 0|je loc_1DBEF_2|mov word [loc_59A52], 0|loc_1DBEF_2: ; enable/disable sound,music driver

loc_27095,15,mov eax, 1 ; fix loading sound driver

loc_26CB5,15,mov eax, 1 ; fix loading music driver

loc_3AA85,4,;mov eax, [esp+0x14]|mov eax, [r11d+0x14]|or eax, eax|je loc_3AAB0 ; fix loading NULL samples
