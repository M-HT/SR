...
loc_49EE9,5,@call loc_10170|ADR tmp1, loc_49EE9_after_call1|stmfd esp!, {tmp1}|b loc_10170|LTORG_CALL|loc_49EE9_after_call1:|@mov eax, 5|mov eax, #5|@call SR_WaitVerticalRetraceTicks2|ADR tmp1, loc_49EE9_after_call2|stmfd esp!, {tmp1}|b SR_WaitVerticalRetraceTicks2|LTORG_CALL|loc_49EE9_after_call2: @ slow down animation
loc_49F57,3,@sub edx, 20|sub edx, edx, #20|@mov eax, 5|mov eax, #5|@call SR_WaitVerticalRetraceTicks2|ADR tmp1, loc_49F57_after_call|stmfd esp!, {tmp1}|b SR_WaitVerticalRetraceTicks2|LTORG_CALL|loc_49F57_after_call: @ slow down animation
