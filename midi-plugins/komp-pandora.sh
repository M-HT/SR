...
$PNDSDK/bin/pandora-gcc -shared -Wl,-soname,midiA-wildmidi.so -o midiA-wildmidi.so -fpic -O2 -Wall midiA-wildmidi.c -I`pwd`/.. -I`pwd`/include -lWildMidiA -L`pwd`/lib/arm
...
CURDIR=`pwd`
$PNDSDK/bin/pandora-gcc -c -fpic -O2 -Wall mpsmusic-driver.c -I$CURDIR/include -I../
cd src
$PNDSDK/bin/pandora-gcc -c -fpic -O3 -Wall -Wno-maybe-uninitialized -DDRIVER=ADLIB emu_x86.c -I$CURDIR/include
$PNDSDK/bin/pandora-g++ -c -fpic -O2 -Wall -fno-exceptions emu_opl2.cpp
cd dosbox_opl
$PNDSDK/bin/pandora-g++ -c -fpic -O3 -Wall -fno-exceptions opl.cpp
cd ../..
...
#cd src
#$PNDSDK/bin/pandora-gcc -c -fpic -O3 -Wall -Wno-maybe-uninitialized -DDRIVER=ROLAND emu_x86.c -I$CURDIR/include
#$PNDSDK/bin/pandora-g++ -c -fpic -O2 -Wall -fno-exceptions emu_mt32.cpp -I$CURDIR/src/munt-1.4.0
#cd munt-1.4.0/mt32emu
#$PNDSDK/bin/pandora-g++ -c -fpic -O3 -Wall -fno-exceptions *.cpp
#cd sha1
#$PNDSDK/bin/pandora-g++ -c -fpic -O3 -Wall -fno-exceptions sha1.cpp
#cd ../../../..
