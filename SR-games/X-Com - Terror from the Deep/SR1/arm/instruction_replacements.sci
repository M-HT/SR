...
loc_4F3D5,107, @ disable checks to allow animated video
loc_5133F,3,@add esp, 4|add esp, esp, #4|@call SR_StartAnimVideo|ADR tmp1, loc_5133F_after_call|stmfd esp!, {tmp1}|b SR_StartAnimVideo|LTORG_CALL|loc_5133F_after_call: @ set sound on start of animated video
loc_513B9,3,@add esp, 3*4|add esp, esp, #3*4|@call SR_StopAnimVideo|ADR tmp1, loc_513B9_after_call|stmfd esp!, {tmp1}|b SR_StopAnimVideo|LTORG_CALL|loc_513B9_after_call: @ restore sound on stop of animated video
